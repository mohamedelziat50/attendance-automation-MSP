...
class AttendanceExporterApp(ctk.CTk):
    """
    GUI application for processing CSV attendance files and exporting to Word.
    ...
    def __create_logo(self):
        ...
        logo_path = resource_path("assets\\msp_logo.png")
    ...
    def __create_upload_button(self):
        ...
        upload_path = resource_path("assets\\upload_icon.png")
    ...
    def __create_export_section(self):
        """Create export section with Label and centered Word button."""
        ...
        # Create centered Word export button
        self.__create_word_button()
        self.word_button.grid(row=0, column=0, padx=0)
    ...
    def __create_word_button(self):
        """Create Word export button with icon and fallback handling."""
        word_path = resource_path("assets\\word_icon.png")
    ...
    def __export_file(self, file_type):
        ...
        # Update status
        self.status_label.configure(
            text=f"Status:\nExporting to Word...", text_color="orange"
        )
    ...
    def __start_export(self, file_type):
        ...
        try:
            ...
            result = messagebox.askyesno(
                "Export Complete!",
                f"Successfully exported Word file:\n{display_filename}\n\nWould you like to open the file location?",
                icon='question'
            )
