...
- Exporting formatted Word/PDF documents as required by the university
	- *If you need page numbers in exported Word documents, add them manually in Word: Insert → Page Number → Bottom of Page → Plain Number 2 (centered). This is due to a python-docx limitation.*
