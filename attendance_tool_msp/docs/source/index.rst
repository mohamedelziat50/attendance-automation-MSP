.. Attendance Tool MSP documentation master file, created by
   sphinx-quickstart on Sat Aug  9 00:25:25 2025.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Attendance Tool MSP documentation
=================================
